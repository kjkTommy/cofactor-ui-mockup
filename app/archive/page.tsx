...
export default function ArchivePage() {
  return (
    <main className="shell section-gap page-stack">
      <section className="archive-hero card card--paper">
        <div>
          <p className="eyebrow">Архив номера</p>
          <h1 className="page-title">Содержание выпуска в digital-формате</h1>
          <p className="lead">
            Страница наследует мотив с ботанической иллюстрацией и плавной
            траекторией из печатного содержания.
          </p>
        </div>
        <div className="archive-art">
          <img src="/assets/leaves-left.jpg" alt="Листья" />
        </div>
      </section>
