      ...
      <section className="about-grid">
        <article className="card card--paper about-lead">
          ...
          <p className="lead">
            ...
            Евгеньевича Кабанова. Доктора с большой буквы, который вот уже больше полувека служит
            другим людям телом и душой, мудростью и знанием, словом и делом.
          </p>
          <p>
            Папа передал любовь к медицине и нам - своим детям. Мой старший брат, Сергей, выпускник
            ПГМА имени академика Е.А. Вагнера, врач-анестезиолог, стоит на страже здоровья и спасения
            жизней людей.
          </p>
          <p>
            Я не стала врачом, но интерес к биологии, физиологии и биохимии сформировал миссию
            просветителя: сделать так, чтобы как можно больше людей начали вести по-настоящему
            здоровый образ жизни. И сейчас мы вместе открываем новую страницу.
          </p>
          <p>
            Здоровье - самое ценное богатство, которое дано каждому человеку. Важно научиться его
            ценить и беречь. Пусть наше общее дело приносит пользу и поддержку многим.
          </p>
        </article>
